" Vim syntax file
" Language:		Inout/Output Stochastic Automata (IOSA)
" Maintainer:		Carlos E. Budde  <cbudde@famaf.unc.edu.ar>
" Last Change:		2017 May 13
" Original Author:	Carlos E. Budde  <cbudde@famaf.unc.edu.ar>
"
" Generated from VIM's haskell syntax highlight file
"
...
" Show primitive types as keywords
...
syn match hsEndModule		"\<endmodule\>"
syn match hsProperties		"\<properties\>"
syn match hsEndProperties	"\<endproperties\>"
...
if exists("hs_highlight_boolean")
  ...
  syn match iosaBoolean "\<\(true\|false\)\>"
endif
if exists("hs_highlight_types")
  " Primitive types from the standard prelude and libraries.
  syn match hsType "\<\(Int\|Integer\|Char\|Bool\|Float\|Double\|IO\|Void\|Addr\|Array\|String\)\>"
  syn match iosaType "\<\(bool\|int\|clock\|exponential\|uniform\|lognormal\|normal\|erlang\|rayleigh\|gamma\|weibull\)\>"
endif
...
if exists("hs_highlight_debug")
  ...
  syn match iosaExtra "\<\(const\|P\|S\|U\)\>"
endif


" Comments
syn match   hsLineComment      "---*\([^-!#$%&\*\+./<=>\?@\\^|~].*\)\?$" contains=iosaLineComment
syn match   iosaLineComment    "///*\([^-!#$%&\*\+./<=>\?@\\^|~].*\)\?$" contains=hsLineComment
...
hi def link hsEndModule			  hsStructure
hi def link hsProperties		  hsStructure
hi def link hsEndProperties		  hsStructure
